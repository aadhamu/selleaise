...
Reach out to us via email or phone — we’d love to hear from you.</p>
          <div class="d-flex flex-column mb-3">
              ...
              <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>olibeychimaoji@gmail.com</p>
              <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+234 9037441520</p>
          </div>
  </div>
</div>
<!-- Contact End -->
...
<?php echo $__env->make('layout.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\selleaise\selleaise\resources\views/frontend/contact.blade.php ENDPATH**/ ?>