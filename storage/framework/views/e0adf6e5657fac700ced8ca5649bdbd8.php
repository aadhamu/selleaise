            ...
            <div class="card border-secondary mb-5">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <h6 class="font-weight-medium" id="shipping">₦<?php echo e(number_format($shipping, 2)); ?></h6>
                    </div>
                    <div class="d-flex justify-content-between mt-2">
                        <h5 class="font-weight-bold">Total</h5>
                        <h5 class="font-weight-bold" id="total">₦<?php echo e(number_format($total, 2)); ?></h5>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\selleaise\selleaise\resources\views/frontend/cart.blade.php ENDPATH**/ ?>