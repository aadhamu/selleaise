...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> | SELLEASE LIMITED</title>
                        ...
                        <div class="relative ml-3">
                            <button class="flex items-center text-sm rounded-full focus:outline-none" id="user-menu-button">
                                ...
                                <div class="flex items-center">
                                    <span class="hidden md:inline mr-2 text-sm font-medium text-gray-700"><?php echo e(Auth::user()->name); ?></span>
                            ...
                            <div class="hidden origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-50" id="user-menu">
                                ...
                                <a href="<?php echo e(route('admin.logout')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                    ...
                    <div class="flex flex-col h-full py-4">
                        ...
                        <div class="flex-1 overflow-y-auto">
                            <nav class="px-2 space-y-1">
                                <ul class="space-y-2">
                                    <li>
                                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-white bg-purple-700/50 hover:bg-purple-700/70 transition-all duration-200">
                                            <i class="fas fa-tachometer-alt w-5 text-center"></i>
                                            <span>Dashboard</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.products.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-purple-200 hover:text-white hover:bg-purple-700/30 transition-all duration-200">
                                            <i class="fas fa-box w-5 text-center"></i>
                                            <span>Products</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.orders.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-purple-200 hover:text-white hover:bg-purple-700/30 transition-all duration-200">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('admin.categories.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-purple-200 hover:text-white hover:bg-purple-700/30 transition-all duration-200">
                                            <i class="fas fa-tags w-5 text-center"></i>
                                            <span>Categories</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.contact.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-purple-200 hover:text-white hover:bg-purple-700/30 transition-all duration-200">
                                            <i class="fas fa-tags w-5 text-center"></i>
                                            <span>Contacts</span>
                                        </a>
                                    </li>
                    ...
                    <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('admin.logout')); ?>" class="text-xs font-medium text-gray-500 hover:text-primary-600"
                                   onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    Sign out
                                </a>
                            </div>
            ...
            <main class="flex-1 overflow-y-auto focus:outline-none bg-gray-50">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div class="mb-6 flex justify-between items-center">
                        <h1 class="text-2xl font-bold text-gray-900"><?php echo $__env->yieldContent('heading', 'Dashboard'); ?></h1>
                        <div class="flex items-center space-x-2 text-sm text-gray-500">
                            <i class="fas fa-clock"></i>
                            <span id="current-time"><?php echo e(now()->format('l, F j, Y g:i A')); ?></span>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="text-sm text-gray-500 mb-2 md:mb-0">
                        &copy; <?php echo e(date('Y')); ?> TENANT LIMITED. All rights reserved.
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\selleaise\selleaise\resources\views/layouts/admin.blade.php ENDPATH**/ ?>