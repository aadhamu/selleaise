    ...
    <div id="product-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner border">
            ...
            <div class="carousel-item <?php echo e($loop->first ? 'active' : ''); ?>">
                <img class="w-100 h-100" src="<?php echo e($image); ?>" alt="<?php echo e($product->name); ?>">
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div class="card product-item border-0">
                ...
                <div class="card-footer d-flex justify-content-between bg-light border">
                    <a href="<?php echo e(route('shop-details', $product->slug)); ?>" class="btn btn-sm text-dark p-0">
...
<?php echo $__env->make('layout.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\selleaise\selleaise\resources\views/frontend/shop-details.blade.php ENDPATH**/ ?>