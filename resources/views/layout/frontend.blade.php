        ...
        <div class="service-banner">
            <div class="row text-center">
                ...
                <div class="col-md-3 col-6 service-item">
                    ...
                    <h5 class="font-weight-bold">Easy Returns</h5>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <ul class="list-unstyled footer-links">
                            ...
                            <li><a href="{{ route('shop') }}"><i class="fa fa-angle-right mr-2"></i>Our Shop</a></li>
                            <!-- <li><a href="#"><i class="fa fa-angle-right mr-2"></i>Featured Products</a></li> -->
                            <li><a href="{{ route('cart') }}"><i class="fa fa-angle-right mr-2"></i>Shopping Cart</a></li>
