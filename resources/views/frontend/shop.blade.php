            ...
            <div class="row pb-3">
                <div class="col-12 pb-1">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <form action="{{ route('shop') }}" method="GET" class="w-75">
                        ...
                        <div class="dropdown ml-4">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                <a class="dropdown-item" href="{{ route('shop', array_merge(request()->query(), ['sort' => 'latest'])) }}">Latest</a>
                                <a class="dropdown-item" href="{{ route('shop', array_merge(request()->query(), ['sort' => 'popularity'])) }}">Popularity</a>
                                <a class="dropdown-item" href="{{ route('shop', array_merge(request()->query(), ['sort' => 'price_asc'])) }}">Price: Low to High</a>
                                <a class="dropdown-item" href="{{ route('shop', array_merge(request()->query(), ['sort' => 'price_desc'])) }}">Price: High to Low</a>
                            </div>
                        </div>
                    </div>
                </div>
